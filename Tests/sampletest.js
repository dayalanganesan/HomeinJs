...
async function runTestWithCaps() {
    ...
    try {
        ...
        await driver.wait(webdriver.until.elementIsVisible(driver.findElement(screenObject.home.btnLogin, 20000))).click();
        await driver.sleep(12000);
        await driver.wait(webdriver.until.elementIsVisible(driver.findElement(screenObject.loginScreen.txtEmail, 50000))).sendKeys(env.username);
       ...
       // switch to frame using web element
        ...
        await driver.findElement(screenObject.homeScreen.ifrHomeScreen);
       // await driver.wait(webdriver.until.elementLocated(driver.findElement(screenObject.homeScreen.ifrHomeScreen, 70000)))
        //await driver.switchTo().frame(driver.findElement(screenObject.homeScreen.ifrHomeScreen));

        /*await driver.wait(webdriver.until.elementIsVisible(driver.findElement(screenObject.homeScreen.btnaddaproperty, 75000))).then(ele => {
            ele.click();
        }).catch(async(ele) => {
        ...
        await driver.sleep(25000);
        await driver.wait(webdriver.until.elementIsVisible(driver.findElement(screenObject.addPropertyScreen.txtPropertyAddress, 10000))).sendKeys("105 Ellery Crescent, Acton ACT 2601");
